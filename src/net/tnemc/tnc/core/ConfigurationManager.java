...
public class ConfigurationManager {
  ...
  public static String getString(String file, String root, String def) {
  ...
  public static ConfigurationSection getConfigurationSection(String file, String path) {
    return configurations.get(file).getOldConfig().getConfigurationSection(path);
  }
  ...
  public static boolean hasConfiguration(String file, String node) {
  ...
  public static int getInt(String file, String node) {

    try {
      return Integer.parseInt(configurations.get(file).getOldConfig().getString(node.toLowerCase(), "1").trim());
    } catch (NumberFormatException e) {
